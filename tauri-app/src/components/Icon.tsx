...
const ICONS = {
  ...
  "list-checks": () => import("@phosphor-icons/core/assets/regular/list-checks.svg?raw"),
  ...
  "sidebar-simple": () => import("@phosphor-icons/core/assets/regular/sidebar-simple.svg?raw"),
