...
over the home screen and appends straight to today's timeline through a JNI call
into `magical_merchant_core` — the app is never started. The "new note" bar
(4×1) and the recent notes list (4×2) open the app on
